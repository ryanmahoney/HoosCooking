...
<body>
	<div id="wrapper">   
		...
		<div class="main_content_container">
			...
			<div id="content">
				<h1 id="title">Meal History</h1>
				<p class="desc">Keep track of all the home-cooked meals that you have shared with others and others have shared with you!</p>
				<div class="two_buttons">
					<button type="button" class="choice_button" id="myself_button">Meals I have prepared</button>
					<button type="button" class="choice_button" id="others_button">Meals others have prepared</button>
				</div>


				<table align="center" class="results" id="my_meals">
					<tr>
						<td colspan="6" class="table_title">Meals prepared by [user]</tr>
					</tr>
					<tr class="headers">
						<th id="blank"></th>
						<th>Meal</th>
					...
					<tr class="sort">
						...
						<th class="sort"><input type="radio" class="rad" name="sort" value=""></th>
						<th class="sort"><input type="radio" class="rad" name="sort" value=""></th>
						<th class="sort"><input type="radio" class="rad" name="sort" value=""></th>
						<th class="sort"><input type="radio" class="rad" name="sort" value=""></th>
						<th class="sort"><input type="radio" class="rad" name="sort" value=""></th>
				...
				<table align="center" class="results" id="others_meals">
					<tr>
						<td colspan="6" class="table_title">Meals prepared by others</tr>
					</tr>
					<tr class="headers">
						<th id="blank"></th>
						<th>Meal</th>
	...
	<script type="text/javascript">
		document.getElementById("myself_button").onclick = function () {
        	document.getElementById("my_meals").style.display="table";
        	document.getElementById("others_meals").style.display="none";
    	};

        document.getElementById("others_button").onclick = function () {
        	document.getElementById("others_meals").style.display="table";
        	document.getElementById("my_meals").style.display="none";
        };
	</script>
</body>
</html>